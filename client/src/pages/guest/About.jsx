  ...
  return (
    <div className="main-container w-full h-auto bg-[#f9faef] relative mx-auto my-0">
      ...
      <div className="w-[1490.387px] h-[562.21px] font-['Libre_Franklin'] text-[20px] font-bold leading-[43px] tracking-[1px] relative text-center z-[8] mt-[40px] text-center mx-auto">
        <span className="font-['Lato'] text-[30px] font-normal leading-[57.282px] text-[#000] tracking-[1px] relative text-center uppercase mx-auto">
        ...
        <span className="font-['Lato'] text-[30px] font-normal leading-[57.282px] text-[#c86c79] tracking-[1px] relative text-center uppercase ">
          natural skin care {" "}
        </span>
        <span className="font-['Lato'] text-[30px] font-normal leading-[57.282px] text-[#000] tracking-[1px] relative text-center uppercase ">
      ...
      <div className="w-full max-w-[1500px] h-[937.456px] relative mx-auto my-0 overflow-hidden">
        <div className="w-[840.663px] h-[224px] font-['Libre_Franklin'] text-[18px] font-normal leading-[31.823px] tracking-[0.8px] absolute top-0 left-[2.647px] text-left z-10">
          ...
          <span className="font-['Lato'] text-[18px] font-light leading-[31.823px] text-[#000] tracking-[0.8px] relative text-left uppercase underline">
            Stephen Strassler  {" "}
          </span>
          <span className="font-['Lato'] text-[18px] font-light leading-[31.823px] text-[#000] tracking-[0.8px] relative text-left uppercase">
            and {" "}
        ...
        <span className="flex w-[840.663px] h-[256px] justify-start items-center font-['Lato'] text-[18px] font-light leading-[31.823px] text-[#000] tracking-[0.8px] absolute top-0 left-[868.506px] text-left uppercase z-[11]">
        ...
        <div className="w-[840.663px] h-[224px] font-['Libre_Franklin'] text-[18px] font-light leading-[31.823px] tracking-[0.8px] absolute top-[690.828px] left-[868.506px] text-left z-[19]">
          ...
          <span className="font-['Lato'] text-[18px] font-light leading-[31.823px] text-[#c86c79] tracking-[0.8px] relative text-left uppercase">
      ...
      <div className="flex w-full max-w-[1085px] h-[37.33px] justify-between items-center relative z-[14] mt-[58.341px] mx-auto">
        <span className="h-[36px] shrink-0 font-['Lato'] text-[22.5px] font-medium leading-[36px] text-[#000] tracking-[0.9px] relative text-left uppercase whitespace-nowrap z-[13]">
          Reviva’s skin care spans generations {" "}
        </span>
        <span className="h-[36px] shrink-0 font-['Lato'] text-[22.5px] font-medium leading-[36px] text-[#000] tracking-[0.9px] relative text-left uppercase whitespace-nowrap z-[14]">
          Get to know us {" "}
        </span>
      </div>
      ...
      <div className="w-full max-w-[1499px] h-[192px] relative z-[25] mt-[13.063px] mx-auto">
        ...
        <div className="w-full max-w-[632px] h-[160px] font-['Libre_Franklin'] text-[18px] font-medium leading-[31.823px] tracking-[0.8px] absolute top-0 left-[867px] text-left z-[25] px-4">
          <span className="font-['Lato'] text-[18px] font-[250] leading-[31.823px] text-[#000] tracking-[0.8px] relative text-left uppercase">
          ...
          <span className="font-['Lato'] text-[18px] font-[250] leading-[31.823px] text-[#ffc0cb] tracking-[0.8px] relative text-left uppercase">
          </span>
          <span className="font-['Lato'] text-[18px] font-[250] leading-[31.823px] text-[#ffc0cb] tracking-[0.8px] relative text-left uppercase underline">
            velvety.com
          </span>
          <span className="font-['Lato'] text-[18px] font-[250] leading-[31.823px] text-[#000] tracking-[0.8px] relative text-left uppercase">
            .
